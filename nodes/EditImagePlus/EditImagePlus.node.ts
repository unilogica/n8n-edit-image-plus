    ...
    options: [
      {
        name: "NorthWest",
        value: "NorthWest",
        description: "NorthWest Text Position",
      },
      {
        name: "North",
        value: "North",
        description: "North Text",
      },
      {
        name: "NorthEast",
        value: "NorthEast",
        description: "NorthEast Text Position",
      },
      {
        name: "West",
        value: "West",
      ...
      },
      {
        name: "Center",
        value: "Center",
        description: "Center Text Position",
      },
      {
        name: "East",
        value: "East",
        description: "East Text Position",
      },
      {
        name: "SouthWest",
        value: "SouthWest",
        description: "SouthWest Text Position",
      },
      {
        name: "South",
        value: "South",
        description: "South Text Position",
      },
      {
        name: "SouthEast",
        value: "SouthEast",
        description: "SouthEast Text Position",
      },
    ],
    default: "Center",
    displayOptions: {
    ...
    for (let itemIndex = 0; itemIndex < length; itemIndex++) {
      try {
        ...
        if (operation === "multiStep") {
          ...
          const operationsData = this.getNodeParameter(
            "operations",
            itemIndex,
            {
              operations: [],
          ...
          requiredOperationParameters[operation].forEach((parameterName) => {
            try {
              operationParameters[parameterName] = this.getNodeParameter(
                parameterName,
                itemIndex
              );
            } catch (error) {}
        ...
        if (operation === "information") {
          ...
          const imageData = await new Promise<IDataObject>(
            (resolve, reject) => {
        ...
        for (let i = 0; i < operations.length; i++) {
          ...
          if (operationData.operation === "blur") {
            ...
            gmInstance = gmInstance!
              ...
              .border(
                operationData.borderWidth as number,
                operationData.borderHeight as number
              );
        ...
        if (item.binary !== undefined && newItem.binary) {
          ...
          if (newItem.binary[dataPropertyName]) {
            newItem.binary[dataPropertyName] = deepCopy(
        ...
        if (options.format !== undefined) {
          ...
          newItem.binary![dataPropertyName].fileExtension =
